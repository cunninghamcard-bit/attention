/**
 * Input: ../app/App, ../plugin/InternalPlugin, ../plugin/InternalPluginWrapper, ../ui/Modal, ../ui/Notice, ../ui/Setting
 * Output: MarkdownImportResult, MarkdownImporterController, createMarkdownImporterPluginDefinition
