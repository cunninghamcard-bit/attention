/**
 * Input: ../app/App, ../app/SettingRegistry, ../plugin/InternalPlugin, ../plugin/InternalPluginWrapper, ../ui/suggest/SuggestModal, ../ui/Setting, ../vault/TAbstractFile, ../app/hotkeys/Keymap, ../ui/Icon
 * Output: QuickSwitcherOptions, QuickSwitcherItem, QuickSwitcherSuggestionItem, QuickSwitcherController, QuickSwitcherModal, createQuickSwitcherPluginDefinition
