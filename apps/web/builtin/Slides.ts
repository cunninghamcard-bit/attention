/**
 * Input: ../app/App, ../plugin/InternalPlugin, ../plugin/InternalPluginWrapper, ../markdown/MarkdownRenderer, ../views/MarkdownView, ../vault/TAbstractFile
 * Output: SlidesController, createSlidesPluginDefinition, splitSlides
