/**
 * Input: ../app/App, ../app/SettingRegistry, ../plugin/InternalPlugin, ../plugin/InternalPluginWrapper, ../ui/Setting, ../views/MarkdownView, ./DailyNotes, ../ui/Icon
 * Output: ZkPrefixerOptions, ZkPrefixerController, createZkPrefixerPluginDefinition
