/**
 * Input: ../../app/App, ../../plugin/InternalPlugin, ../../plugin/InternalPluginWrapper, ../../views/View, ../../views/workspace/WorkspaceLeaf, ./GitCommitView, ./GitHubDetailView, ./GitHubListView, ./GitHubNavView, ./GitHubProfileView
 * Output: createGitHubPluginDefinition
