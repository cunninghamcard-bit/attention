...
interface ElectronBridge {
  ipcRenderer?: {
    // Channel names are constrained by the shared IPC table (the renderer side
    // of the one typed contract the main handlers also reference).
    sendSync?: (channel: SyncChannelName) => unknown;
  };
}
