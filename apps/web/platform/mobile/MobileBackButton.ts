/**
 * Input: ../../app/App, ../../ui/ActiveCloseableRegistry, ../../ui/Notice, ./MobileDrawer
 * Output: MobileBackButtonBridge, MobileBackButtonOptions, MobileBackButtonController, createDefaultMobileBackButtonBridge
