/**
 * Input: ../app/App
 * Output: PluginDebugInfo, PluginDevTools
...
export class PluginDevTools {
  ...
  listRecentLogs(): readonly import("../app/diagnostics/Logger").LogEntry[] {
    return this.app.diagnostics.logger.list();
  }

  listErrors(): readonly import("../app/diagnostics/ErrorReporter").ErrorReport[] {
