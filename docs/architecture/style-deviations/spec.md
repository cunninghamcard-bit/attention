...
- reading-view.css is a measured, documented CSS stand-in for Obsidian's
  runtime container sizing (its header carries the measurements) —
  verdict DELIBERATE DEVIATION, now styles/deviations/reading-view.css,
  the registry's first and only entry.
