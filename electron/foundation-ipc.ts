 ...
 * `WorkspaceWindow.ts` → `is-quitting`). Registering them here keeps the very
 * first paint clean. The *full* channel table (vault*, trash, request-url,
 * menu, dialogs, ...) is L5 — this file only owns the two channels the
 * foundation itself is responsible for.
 */
