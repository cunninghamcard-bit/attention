...
import { LicenseManager } from "../account/LicenseManager";
...
export class App {
  ...
  readonly licenses = new LicenseManager(this.accounts);
  readonly vaults = new VaultManager(this);
  readonly remoteSync = new RemoteSyncProvider(this);
  readonly revisions = new RevisionHistoryService(this);
  readonly fileRecovery = new FileRecoveryService(this);
  readonly publish = new PublishService(this);
  ...
  readonly bases = new BasesRegistry(this);
  readonly functionRegistry = new BasesFunctionRegistry();
  ...
  readonly sync = new SyncEngine(this);
