...
import type { SettingsSectionDefinition } from "../app/SettingsSection";
import type { ViewCreator } from "../views/workspace/ViewRegistry";
import type { HoverLinkSource, HoverLinkSourceConfig } from "../views/workspace/WorkspaceHover";
import type { ObsidianProtocolHandler } from "../app/protocol/UriRouter";
