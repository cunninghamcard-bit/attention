...
export class MenuManager {
  ...
  createFilesMenu(
    files: TAbstractFile[],
    source: FileMenuSource = "file-explorer-context-menu",
    leaf?: WorkspaceLeaf,
  ): Menu {
    const menu = new Menu();
  ...
  createEditorMenu(editor: Editor, view: View, context: EditorMenuContext = {}): Menu {
    ...
    else if (context.externalRefLink)
      this.addEditorExternalRefLinkContextItems(menu, context.externalRefLink);
  ...
  private addEditorLinkContextItems(
    menu: Menu,
    editor: Editor,
    context: EditorMenuLinkContext,
  ): void {
    menu.addItem((item) =>
      item
        .setTitle("Edit link")
  ...
  private addEditorExternalRefLinkContextItems(
    menu: Menu,
    context: EditorMenuExternalRefLinkContext,
  ): void {
    this.app.workspace.handleExternalLinkContextMenu(menu, context.href);
  }

  private addEditorTagContextItems(
    menu: Menu,
    editor: Editor,
    context: EditorMenuTagContext,
  ): void {
    menu.addItem((item) =>
      item
        .setTitle("Edit tag")
  ...
  private addEditorFootrefContextItems(
    menu: Menu,
    editor: Editor,
    context: EditorMenuFootrefContext,
  ): void {
    menu.addItem((item) =>
      item
  ...
  createMarkdownViewportMenu(
    view: View,
    mode: MarkdownViewportMenuMode,
    source: MarkdownViewportMenuSource,
  ): Menu {
    const menu = new Menu();
  ...
  createLinkMenu(
    linktext: string,
    sourcePath: string,
    source: LinkMenuSource = "markdown-link",
  ): Menu {
    const menu = new Menu();
    menu.addItem((item) =>
      item
...
function getEditorSuggestTarget(view: View): HTMLElement | null {
  ...
  const candidate = (view as View & { editorViewHost?: { contentEl?: unknown } }).editorViewHost
    ?.contentEl;
