...
const ICON_PATHS: Record<string, string> = {
  ...
  "lucide-book-open":
    '<path d="M12 7v14"/><path d="M3 18a1 1 0 0 1-1-1V5a1 1 0 0 1 1-1h5a4 4 0 0 1 4 4 4 4 0 0 1 4-4h5a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1h-6a3 3 0 0 0-3 3 3 3 0 0 0-3-3z"/>',
  ...
  "lucide-file-question":
    '<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v6h6"/><path d="M10 13a2 2 0 1 1 3.3 1.5c-.8.5-1.3 1-1.3 2"/><path d="M12 19h.01"/>',
  "lucide-file-search":
    '<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h6"/><path d="M14 2v6h6"/><circle cx="15" cy="15" r="3"/><path d="m17.5 17.5 3 3"/>',
  "lucide-folder":
  ...
  "lucide-folder-cog":
    '<path d="M10 20H4a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2v3"/><circle cx="16" cy="16" r="2"/><path d="M16 12v1"/><path d="M16 19v1"/><path d="m13.4 13.4.7.7"/><path d="m17.9 17.9.7.7"/><path d="M12 16h1"/><path d="M19 16h1"/><path d="m13.4 18.6.7-.7"/><path d="m17.9 14.1.7-.7"/>',
  "lucide-folder-tree":
    '<path d="M20 10a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2h-7.9a2 2 0 0 1-1.7-.9L9.6 2.1A2 2 0 0 0 7.9 1H4a2 2 0 0 0-2 2v5a2 2 0 0 0 2 2Z"/><path d="M4 10v4a2 2 0 0 0 2 2h5"/><path d="M11 16h5"/><path d="M16 16v5"/><path d="M20 21h-8a2 2 0 0 1-2-2v-1a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v1a2 2 0 0 1-2 2Z"/>',
  ...
  "lucide-git-merge":
    '<path d="m8 6 4-4 4 4"/><path d="M12 2v10"/><path d="M18 22a4 4 0 0 0-4-4h-4a4 4 0 0 1-4-4V8"/><path d="M6 8l-4 4 4 4"/>',
  "lucide-globe":
  ...
  "lucide-clipboard-paste":
    '<path d="M15 2H9a1 1 0 0 0-1 1v2a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V3a1 1 0 0 0-1-1Z"/><path d="M8 4H6a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-2"/><path d="M16 4h2a2 2 0 0 1 2 2v2"/><path d="M11 14h10"/><path d="m17 10 4 4-4 4"/>',
  "lucide-wrap-text":
  ...
  "lucide-keyboard":
    '<rect x="2" y="6" width="20" height="12" rx="2"/><path d="M6 10h.01"/><path d="M10 10h.01"/><path d="M14 10h.01"/><path d="M18 10h.01"/><path d="M8 14h8"/><path d="M18 14h.01"/><path d="M6 14h.01"/>',
  "lucide-layers":
    '<path d="m12.83 2.18a2 2 0 0 0-1.66 0L2.6 6.08a1 1 0 0 0 0 1.82l8.57 3.9a2 2 0 0 0 1.66 0l8.57-3.9a1 1 0 0 0 0-1.82z"/><path d="m22 12-9.17 4.18a2 2 0 0 1-1.66 0L2 12"/><path d="m22 17-9.17 4.18a2 2 0 0 1-1.66 0L2 17"/>',
  ...
  "lucide-unlink":
    '<path d="m18.84 12.25 1.72-1.71a5 5 0 0 0-7.07-7.07l-1.72 1.71"/><path d="m5.17 11.75-1.73 1.71a5 5 0 0 0 7.07 7.07l1.72-1.71"/><path d="M8 12h8"/><path d="m2 2 20 20"/>',
  ...
  "lucide-palette":
    '<circle cx="13.5" cy="6.5" r=".5"/><circle cx="17.5" cy="10.5" r=".5"/><circle cx="8.5" cy="7.5" r=".5"/><circle cx="6.5" cy="12.5" r=".5"/><path d="M12 2C6.5 2 2 6 2 11.5S6.5 22 12 22h1.5a2.5 2.5 0 0 0 0-5H12a1.5 1.5 0 0 1 0-3h4.5A5.5 5.5 0 0 0 22 8.5C22 4.9 17.5 2 12 2z"/>',
  "lucide-pin":
    '<path d="M12 17v5"/><path d="M9 10.76V7a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v3.76l2 2V15H7v-2.24z"/><path d="M8 3h8"/>',
  "lucide-pin-off":
    '<path d="M12 17v5"/><path d="m2 2 20 20"/><path d="M10.7 5A2 2 0 0 1 12 4h2a2 2 0 0 1 2 2v3.76l2 2V15h-2.24"/><path d="M8.24 15H7v-2.24l2-2V7"/>',
  "lucide-plus": '<path d="M5 12h14"/><path d="M12 5v14"/>',
  "lucide-puzzle":
    '<path d="M15.4 4.6a2.1 2.1 0 1 0-2.9-2.9L9.9 4.3H4a2 2 0 0 0-2 2v5.6l2.6-2.6a2.1 2.1 0 1 1 2.9 2.9L4.9 14.8V20a2 2 0 0 0 2 2h5.2l-2.6-2.6a2.1 2.1 0 1 1 2.9-2.9l2.6 2.6H20a2 2 0 0 0 2-2v-5.2l-2.6 2.6a2.1 2.1 0 1 1-2.9-2.9l2.6-2.6V4h-5.6z"/>',
  "lucide-picture-in-picture":
    '<path d="M8 4h10a2 2 0 0 1 2 2v10"/><path d="M2 10a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2z"/><path d="M10 13h3v3"/>',
  "lucide-picture-in-picture-2":
    '<path d="M8 4h10a2 2 0 0 1 2 2v10"/><path d="M2 10a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2z"/><path d="M10 13h3v3"/>',
  "lucide-refresh-cw":
    '<path d="M3 12a9 9 0 0 1 15-6.7L21 8"/><path d="M21 3v5h-5"/><path d="M21 12a9 9 0 0 1-15 6.7L3 16"/><path d="M3 21v-5h5"/>',
  "lucide-scan-eye":
    '<path d="M3 7V5a2 2 0 0 1 2-2h2"/><path d="M17 3h2a2 2 0 0 1 2 2v2"/><path d="M21 17v2a2 2 0 0 1-2 2h-2"/><path d="M7 21H5a2 2 0 0 1-2-2v-2"/><path d="M2 12s3-5 10-5 10 5 10 5-3 5-10 5S2 12 2 12z"/><circle cx="12" cy="12" r="3"/>',
  "lucide-scroll-text":
    '<path d="M8 21h12a2 2 0 0 0 2-2V5a3 3 0 0 0-3-3H8"/><path d="M8 21a3 3 0 0 1-3-3V5a3 3 0 1 0-3 3h3"/><path d="M10 8h8"/><path d="M10 12h8"/><path d="M10 16h5"/>',
  ...
  "lucide-separator-vertical":
    '<line x1="12" y1="3" x2="12" y2="21"/><polyline points="8 8 4 12 8 16"/><polyline points="16 16 20 12 16 8"/>',
  "lucide-settings":
  ...
  "lucide-terminal-square":
    '<rect x="3" y="3" width="18" height="18" rx="2"/><path d="m7 15 4-4-4-4"/><path d="M13 17h4"/>',
  "lucide-tags":
    '<path d="m15 5 6.3 6.3a2.4 2.4 0 0 1 0 3.4l-4.6 4.6a2.4 2.4 0 0 1-3.4 0L7 13V5z"/><path d="M9.5 7.5h.01"/><path d="m4 8 6.3 6.3"/>',
  "lucide-text": '<path d="M17 6H3"/><path d="M21 12H3"/><path d="M15 18H3"/>',
  "lucide-toy-brick":
    '<rect x="3" y="8" width="18" height="12" rx="2"/><path d="M7 8V5a2 2 0 0 1 2-2h1v5"/><path d="M14 8V5a2 2 0 0 1 2-2h1v5"/><path d="M7 14h.01"/><path d="M12 14h.01"/><path d="M17 14h.01"/>',
  "lucide-trash-2":
  ...
  "lucide-check-circle-2": '<circle cx="12" cy="12" r="10"/><path d="m9 12 2 2 4-4"/>',
...
function normalizeIconName(icon: string): string {
  ...
  return CUSTOM_ICONS.has(lucideIcon) || BUILTIN_ICONS.has(lucideIcon)
    ? lucideIcon
    : normalizedIcon;
}
