...
import { createTerminalFocusScope, isSystemChord } from "@web/builtin/terminal/TerminalView";
import { normalizedKeymapEventFromKeyboardEvent } from "@web/app/hotkeys/Scope";
