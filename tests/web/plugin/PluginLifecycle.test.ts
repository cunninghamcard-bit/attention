...
import type { PluginManifest, PluginPackage } from "@web/plugin/PluginManifest";
import { CorePluginSettingTab, PluginSettingTab } from "@web/plugin/PluginSettingTab";
import {
